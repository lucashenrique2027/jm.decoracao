...
export const buscarFaturamentoClientes = async (periodo = 'mes') => {
  const response = await fetch(`${API}/faturamento-clientes?periodo=${periodo}`, { credentials: 'include' });
...
export const buscarProdutosMaisVendidos = async (periodo = 'mes') => {
  const response = await fetch(`${API}/produtos-mais-vendidos?periodo=${periodo}`, { credentials: 'include' });
...
export const buscarCategoriasMaisVendidas = async (periodo = 'mes') => {
  const response = await fetch(`${API}/categorias-mais-vendidas?periodo=${periodo}`, { credentials: 'include' });
