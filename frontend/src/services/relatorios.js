...
export const buscarProdutos = async (inicio, fim) => {
  ...
  const response = await fetch(
    `${API}/produtos?inicio=${inicio}&fim=${fim}`,
    {
      credentials: 'include',
    }
  );
...
export const buscarCategorias = async (inicio, fim) => {
  ...
  const response = await fetch(
    `${API}/categorias?inicio=${inicio}&fim=${fim}`,
    {
      credentials: 'include',
    }
  );
  ...
  if (!response.ok) {
    throw new Error('Erro ao buscar relatório de categorias');
  }
...
export const baixarPdfFaturamento = async (inicio, fim) => {
  ...
  const response = await fetch(
    `${API}/faturamento/pdf?inicio=${inicio}&fim=${fim}`,
    {
      credentials: 'include',
    }
  );
  ...
  if (!response.ok) {
    throw new Error('Erro ao baixar PDF de faturamento');
  }
...
export const baixarPdfProdutos = async (inicio, fim) => {
  ...
  const response = await fetch(
    `${API}/produtos/pdf?inicio=${inicio}&fim=${fim}`,
    {
      credentials: 'include',
    }
  );
  ...
  if (!response.ok) {
    throw new Error('Erro ao baixar PDF de produtos');
  }
...
export const baixarPdfCategorias = async (inicio, fim) => {
  ...
  const response = await fetch(
    `${API}/categorias/pdf?inicio=${inicio}&fim=${fim}`,
    {
      credentials: 'include',
    }
  );
  ...
  if (!response.ok) {
    throw new Error('Erro ao baixar PDF de categorias');
  }
